...
\citep{chakravarthy1998collision}, is widely used. The CC defines a~region in
...
\citep{black2022probabilistic, singletary2023chance} and Stochastic Safety
Certificates \citep{dean2020guaranteeing}. These approaches typically employ
...
This formula will be reformulated in next section to has form as in equaltion 
...
MATLAB/Simulink, second stage on real robots.
    ...
    \subsection{Simulations}
        ...
        \begin{figure}[H]
        \begin{center}
            \includegraphics[width=1.0\linewidth]{fig/trajectories.eps}
        ...
        \begin{figure}[H]
        \begin{center}
            \includegraphics[width=1.0\linewidth]{fig/distance.eps}
        ...
        \begin{figure}[H]
        \begin{center}
            \includegraphics[width=1.0\linewidth]{fig/positions.eps}
        ...
        \begin{figure}[H]
        \begin{center}
            \includegraphics[width=1.0\linewidth]{fig/trajectories_bicycle.eps}
        ...
        \begin{figure}[H]
        \begin{center}
            \includegraphics[width=1.0\linewidth]{fig/distance_bicycle.eps}
